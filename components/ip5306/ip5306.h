...
class IP5306 : public PollingComponent, public i2c::I2CDevice {
 public:
  ...
  // Setters pre Switche (presne tak, ako ich hlada main.cpp)
 ...
 private:
  ...
  // Premenne pre zabranenie spamu v logu
  float last_battery_level_{-1};
  float last_current_{-1};
  std::string last_load_status_{""};
  bool last_charger_connected_{false};
  bool last_charge_full_{false};
