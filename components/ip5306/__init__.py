...
CONF_CHARGER_CONTROL = "charger_control"  # NEW: Ovládanie nabíjania
CONF_LOAD_SHUTDOWN_TIME = "load_shutdown_time"  # NEW: Čas vypnutia záťaže
...
CONFIG_SCHEMA = cv.COMPONENT_SCHEMA.extend(
    {
        ...
        cv.Optional(CONF_CHARGER_CONTROL): switch.switch_schema(IP5306Switch),  # NEW
        cv.Optional(CONF_LOAD_SHUTDOWN_TIME): select.select_schema(IP5306Select),  # NEW
